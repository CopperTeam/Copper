...
namespace Copper.Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string _assemblySkipLoadingPattern = "^System|^Microsoft|^Autofac|^AutoMapper|^EntityFramework|^log4net|^Newtonsoft|^WebGrease|^Webdiyer|^Oracle|~MySql|^FluentValidation|~EPPlus|~ImageResizer|~CopperAuthorization";
