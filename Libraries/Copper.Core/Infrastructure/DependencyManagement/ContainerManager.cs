...
namespace Copper.Core.Infrastructure.DependencyManagement
{
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new CopperException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (CopperException)
                {

                }
            }
            throw new CopperException("No contructor was found that had all the dependencies satisfied.");
        }
