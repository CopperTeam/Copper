...
namespace Copper.Core
{
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into Copper, 
        ...
        protected virtual string ServerVariables(string name)
        {
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new CopperException("Copper needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
